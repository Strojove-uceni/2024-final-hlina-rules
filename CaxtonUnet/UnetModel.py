...
import torch
from UnetModelCompenents import DoubleConv, PoolingBlock, DownSample, AttentionModule_stage1, UpSample
from UnetModelCompenents import AttentionModule_stage2, AttentionModule_stage3
...
class RosNet(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # Final convolution
        self.final_conv = nn.Conv2d(1024, 512, 1)
