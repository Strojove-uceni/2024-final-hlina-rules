...
from DataPreprocessing import CalculateMeanStd, CenteredCrop, RandomCrop
...
model = RosNet(in_channels=3, out_channels=64)
...
with open('final_unet_test_metricsfrfrfrosnet.pkl', 'wb') as f:
    pickle.dump(test_metrics, f)

with open('final_unet_test_predslabelsfrfrfrfrosnet.pkl', 'wb') as f:
    pickle.dump({
        ...
        'test_feed_rate_labels': feed_rate_labels,
        'test_flow_rate_predictions': flow_rate_predictions,
        'test_flow_rate_labels': flow_rate_labels
    }, f)
